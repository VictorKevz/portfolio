  ...
  return (
    <div className="w-full mt-8">
      <header className="w-full">
        ...
        <p className="text-sm md:text-base mt-1 w-[90%] max-5xl">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2  gap-8 mt-8">
        {data.map((card) => (
          <div
            key={card.id}
            className="relative overflow-hidden min-h-60 rounded-xl w-full transition-all duration-500 ease-in-out shadow-xl hover:cursor-pointer hover:shadow-blue-400/10"
            style={{
          ...
          >
            <div className="flex flex-col px-3 py-4 bg-[var(--neutral-200)] absolute -right-px -bottom-px w-fit rounded-b-[.79rem] transition-all duration-300 ease-in-out">
              <h4>{card.title}</h4>
